...
<script setup>
import ResourceFile from '../src/type/file.js'
import { checkFontFile , checkMediaFile } from '../src/util.js'
...
import ProgressDialog from '../src/component/progress-dialog.vue'
ft.instance()
